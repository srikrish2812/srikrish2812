...
- I did my Bachelors in Electrical Engineering at IIT-Tirupati. During this time I developed interest towards DL and Computer Vision and gained deep theoretical knowledge in these subjects from a signal processing perspective.
- During bachelors, I was fortunate enough to work in the [ViSAL](https://sites.google.com/iittp.ac.in/ee-spcv-lab/people/faculty) lab under the guidance of [Dr RamaKrishna Gorthi](https://ee.iittp.ac.in/Faculty_Rkg.html). I did my thesis on efficient data augmentation method for detecting drones by integrating classical computer vision and deep learning methods.
